...
🌐 **Live Demo**
(Allow third party cookie for this site.)
...
<img width="679" height="608" alt="WhatsApp Image 2026-07-07 at 20 14 37" src="https://github.com/user-attachments/assets/f1dc30f7-2e70-408d-9f23-76c9ac25a4d9" />
...
- Login Page
- <img width="486" height="565" alt="WhatsApp Image 2026-07-07 at 19 29 29" src="https://github.com/user-attachments/assets/1be65a1a-ecda-44ec-92d3-1e61976241a3" />

- Signup Page
- <img width="393" height="590" alt="WhatsApp Image 2026-07-07 at 19 30 04" src="https://github.com/user-attachments/assets/95554413-a657-493f-9eae-1a783cfdd548" />

- Forgot Password
- <img width="503" height="276" alt="image" src="https://github.com/user-attachments/assets/347e99ce-1ac4-4f5e-8222-9e811383c0a0" />

- OTP Verification
- <img width="509" height="299" alt="image" src="https://github.com/user-attachments/assets/fcb6b035-ef09-4322-8072-22c947d8d5d8" />
...
Customer --> Frontend
RestaurantOwner --> Frontend
DeliveryPartner --> Frontend
...
Backend --> Email[Nodemailer OTP Service]

Backend <-->|Realtime Events| SocketIO[Socket.IO Server]
```
...
B -->|Sign Up| C[Create Account]

B -->|Sign In| D[Verify Credentials]

B -->|Google Login| E[Firebase Authentication]

B -->|Forgot Password| F[Generate OTP]
...
Backend->>Owner: New Order Notification

Owner->>Backend: Accept Order

Backend->>Customer: Order Accepted

Owner->>Backend: Assign Delivery Boy

Backend->>Delivery: Delivery Request

Delivery->>Backend: Accept Delivery

Backend->>Customer: Delivery Partner Assigned

Delivery->>Backend: Update Location

Backend->>Customer: Live Tracking

Delivery->>Customer: Request Delivery OTP

Customer->>Backend: OTP Verification

Backend->>Delivery: Delivery Successful

Backend->>Owner: Order Completed
```
